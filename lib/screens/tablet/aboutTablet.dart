            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _sectionHeading(AppText.aboutBodyText3),
                    _sectionText(AppText.aboutBodyText4),
                    _sectionText(AppText.aboutBodyText5, bold: true),
                    _divider(),
                    _sectionHeading(AppText.aboutBodyText6),
                    const SizedBox(height: 5),

                    // 🔄 Skills as Wrap to avoid overflow
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20),
                      child: Wrap(
                        spacing: 8,
                        ...
                        children: [
                          ...
                          AppText.supaBase,
                        ].map((text) => Text(text, style: textStyle)).toList(),
                      ),
                    ),
                      ...
                      children: [
                        Expanded(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _infoBlock(AppText.aboutBodyText15,
                                  AppText.aboutBodyText16),
                              const SizedBox(height: 10),
                              _infoBlock(AppText.aboutBodyText19,
                                  AppText.aboutBodyText20),
                        ...
                        Expanded(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _infoBlock(AppText.aboutBodyText17,
                                  AppText.aboutBodyText18),
                              const SizedBox(height: 10),
                              _infoBlock(AppText.aboutBodyText21,
...
Widget _sectionText(String text, {bool bold = false}) => Padding(
  padding: const EdgeInsets.only(left: 23, right: 50),
  child: Text(
    text,
    style: TextStyle(
...
Widget _infoBlock(String title, String subtitle) => Padding(
  padding: const EdgeInsets.only(left: 23, right: 50),
  child: RichText(
    text: TextSpan(
      children: [
